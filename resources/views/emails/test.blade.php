      ...
      <tr>
        <td>
          <table align="center" border="0" cellpadding="0" cellspacing="0" style="position:relative">  
            <tr>
        <td>
        <span style="width: 146px;height: 39px;background: rgba(21, 28, 38, 0.5);border-radius: 4px;padding: 15px 10px 10px 10px;display: block;margin: 0 auto;text-align: center;margin-top: 20px;"><a href="#"><img src="{{ URL::asset('upload/source/'.getcong('site_logo')) }}" border="0" alt="" /></a></span>
              </td>
            </tr>
          </table>                    
        </td>
