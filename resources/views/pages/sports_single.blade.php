								...
								<div class="col-md-5 col-xs-12">
									<div class="news-share">
										...
										<div class="share-social">
											<a href="https://www.facebook.com/sharer/sharer.php?u={{share_url_get('sports',$sports_info->id)}}" target="_blank"><i class="fa fa-facebook"></i></a>
											<a href="https://twitter.com/intent/tweet?text={{$sports_info->video_title}}&amp;url={{share_url_get('sports',$sports_info->id)}}"><i class="fa fa-twitter"></i></a>
											<a href="http://pinterest.com/pin/create/button/?url={{share_url_get('sports',$sports_info->id)}}&media={{URL::to('upload/source/'.$sports_info->video_image)}}&description={{$sports_info->video_title}}"><i class="fa fa-pinterest"></i></a>
											<a href="https://wa.me?text={{share_url_get('sports',$sports_info->id)}}" data-action="share/whatsapp/share"><i class="fa fa-whatsapp"></i></a>
