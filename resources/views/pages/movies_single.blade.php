       ...
       <div class="modal-content">
        ...
        <div class="modal-body">
          <p><main>
			...
			<div id="container">                   
	        	<video id="v_player_trailer" class="video-js vjs-big-play-centered skin-blue vjs-16-9" controls preload="auto" playsinline width="640" height="450" poster="{{URL::to('upload/source/'.$movies_info->video_image)}}" data-setup="{}">
