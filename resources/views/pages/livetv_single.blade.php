								...
								<div class="col-md-5 col-xs-12">
									<div class="news-share">
										...
										<div class="share-social">
											<a href="https://www.facebook.com/sharer/sharer.php?u={{share_url_get('livetv',$tv_info->id)}}" target="_blank"><i class="fa fa-facebook"></i></a>
                      <a href="https://twitter.com/intent/tweet?text={{$tv_info->channel_name}}&amp;url={{share_url_get('livetv',$tv_info->id)}}"><i class="fa fa-twitter"></i></a>
                      <a href="http://pinterest.com/pin/create/button/?url={{share_url_get('livetv',$tv_info->id)}}&media={{URL::to('upload/source/'.$tv_info->channel_thumb)}}&description={{$tv_info->channel_name}}"><i class="fa fa-pinterest"></i></a>
                      <a href="https://wa.me?text={{share_url_get('livetv',$tv_info->id)}}" data-action="share/whatsapp/share"><i class="fa fa-whatsapp"></i></a>
