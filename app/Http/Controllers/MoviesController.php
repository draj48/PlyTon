...
class MoviesController extends Controller
{
    ...
    {   
       ...
       if($movies_info=='')
       {
        ...
        {
            return view('pages.movies_single_upcoming',compact('movies_info','latest_movies_list','related_movies_list')); 
        }
        else
        {
    ...
    public function movies_share_single($id)
    {   
       ...
       if($movies_info=='')
       {
        ...
        return view('pages.movies_single_share',compact('movies_info','latest_movies_list','related_movies_list')); 
    }         
}