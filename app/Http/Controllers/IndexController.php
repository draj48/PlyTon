...
{   
    ...
    {   
        ...
        return view('pages.index',compact('slider','recently_watched','upcoming_movies','upcoming_series','home_sections','section3_lang_id','home_sections_list3','section4_lang_id','home_sections_list4','section5_lang_id','home_sections_list5'));
