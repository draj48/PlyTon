...
class SettingsController extends MainAdminController
{
    ...
    {  
        ...
        $settings->braintree_merchant_id = $inputs['braintree_merchant_id'];
        $settings->braintree_public_key = $inputs['braintree_public_key'];
        $settings->braintree_private_key = $inputs['braintree_private_key'];
        $settings->braintree_merchant_account_id = $inputs['braintree_merchant_account_id'];
